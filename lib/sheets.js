...
async function leerGastos(ssid, mesFilter) {
  ...
  return rows.slice(2).filter(function (r) {
    ...
    // P (índice 15) = link de Drive de la factura ya movida a la carpeta
    // de imputados. Si por algún motivo esa columna quedó vacía (ej. el
    // movimiento del archivo falló pero la imputación siguió), se usa
    // O (índice 14, el link original) como respaldo.
